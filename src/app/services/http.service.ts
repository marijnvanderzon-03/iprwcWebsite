...
export class HttpService {
  ...
  public postFormData<FormData>(endpoint: string, body: FormData, implementation: (data: FormData) => void, onFailure : () => void) {
    this.http.post<HttpResponse<FormData>>(this.url + endpoint, body).subscribe((response) => {
      HttpService.callImplementation<FormData>(response, implementation, onFailure);
    });
  }
